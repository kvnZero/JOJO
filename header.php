        ...
        <nav class="navbar navbar-expand-lg w-100 px-md-5">
            <div class="container-fluid">
                ...
                if ( has_custom_logo() && false) {
                    ...
                    <?php
                    echo '<a href="'.home_url().'"><img class="header-logo-img" src="' . esc_url( $logo[0] ) . '" alt="' . get_bloginfo( 'name' ) . '"></a>';
                    ?>
                    </a>
                    <?php
                } else {
                ...
                <div class="d-flex">
                            ...
                            if( $enable_header_language) {
                                ...
                                <div class="btn-group">
                                    ...
                                    <form action="/" method="GET" id="lang-form">
                                        <input type="hidden" name="wp_lang" value="<?php get_user_locale(); ?>">
                    ...
                    if(!empty(wp_get_nav_menu_object( $locations[ "header-menu" ] ))){
                        ?>
