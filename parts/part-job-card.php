...
$job_type_icon = $job_type ? wpjam_get_term_thumbnail_url($job_type[0]) : null;

?>
<li class="list-group-item job-item mb-4">
  <a href="<?php echo get_post_permalink();?>">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-2 col-md-2 col-lg-1 job-type-icon justify-content-center">
          ...
          <div class="col-8 col-md-10 col-lg-10">
            ...
            <div class="row job-excerpt">
                <div>
                <?php echo nl2br(get_the_excerpt());?>
                </div>
            </div>
          </div>
          <div class="d-none col-lg-1 col-lg-flex d-lg-flex align-items-center justify-content-center">
